...
import { getThemeSpec, type ThemeSpec } from "@infini-dev-kit/frontend/theme/theme-specs";
import { getThemeOverrides } from "@infini-dev-kit/frontend/theme/theme-overrides";
import { buildMantineComponents } from "./mantine-components";
import { resolveControlGlow } from "@infini-dev-kit/frontend/theme/tokens/control-glow";
...
export { buildScopedThemeClass, buildScopedCssVariables } from "@infini-dev-kit/frontend/theme/tokens/mantine-variables";
export { applyLocaleTypography, type LocaleCode } from "@infini-dev-kit/frontend/theme/tokens/locale-typography";
